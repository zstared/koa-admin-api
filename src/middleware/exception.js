    ...
    try {
        ...
        if (err) {
            ...
            let body = {
                ...
                message: err.msg ? err.msg : getLocale(language)[err.code] ? getLocale(language)[err.code] : getLocale(language)['1000000'],
            ...
            let body = {
                code: 1000000,
                message: getLocale(language)['1000000'],
                desc: getLocale(language)['1000000'],
                data: {}
            };
            ctx.body = body;
        }
